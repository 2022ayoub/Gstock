...
if(!empty($_GET["id"])){
  $fournisseur=getFournisseur($conn,$_GET["id"]);
}
?>
<div class="home-content">
  <div class="overview-boxes">
    <div class="box">
      <form action="<?= !empty($_GET["id"]) ? "../model/fournisseur/updateFournisseur.php" : "../model/fournisseur/addFournisseur.php" ?>" method="post">
    ...
    <div class="box client">
      <table class="mtable">
        ...
        <?php 
          ...
          if(!empty($fournisseurs) && is_array($fournisseurs)):foreach($fournisseurs as $key=>$val):
        ?>
